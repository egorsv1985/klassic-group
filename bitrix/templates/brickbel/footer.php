		...
		<div class="row">
			<div class="col-12 col-md-7 col-lg-6 mt-md-5 mb-3">
				...
				<div class="row gy-3 mb-md-5">
					...
					<div class="col-12">
						<a href="viber://chat?number=+375445455897" class="d-block rounded-2 border border-dashed border-primary fs-16 text-info py-3 ps-2 ps-lg-4 pe-2 text-nowrap h-100">
			...
			<div class="col-12 col-md-5 col-lg-4 mt-md-5 mb-3 pt-3">
				...
				<div class="row g-4">
					...
					<div class="col-6 mt-5">
						...
						<a href="mailto:klassik-grupp@mail.ru" class="d-block fs-15">klassik-grupp@mail.ru</a>
			...
			<div class="col12 col-sm-5 col-lg-4 offset-lg-2 offset-sm-1">
				<div class="col-12 col-sm-6">
					<ul class="d-flex gap-2 ps-0 m-0">
						<li class="">
							<a href="#" class="d-none" title="Teleramm">
						...
						<li class="">
							<a href="viber://add?number=375445455897" class="d-block" title="Viber">
								<svg width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
