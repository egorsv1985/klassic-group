...
<form class="form pb-5" name="iblock_add" action="<?= POST_FORM_ACTION_URI ?>" method="post" enctype="multipart/form-data">
	<div class="row g-4">
		...
		<div class="col-12 col-sm-6">
			<button type="submit" class="btn fs-20 fw-500 px-3 py-3 btn-primary <?= (strpos($APPLICATION->GetCurPage(), 'zelenye-zabory')  !== false) ? ' btn--green' : '' ?> bg-gradient w-100 border-0">
				Отправить
			</button>
		</div>
	</div>
