(() => {
        ...
        if (
          ...
          if ("auto" === i.slidesPerView) {
            ...
            if (
              ...
              L = e.isHorizontal() ? v(n, "width", !0) : v(n, "height", !0);
            else {
              const e = s(a, "width"),
                t = s(a, "padding-left"),
                i = s(a, "padding-right"),
            ...
            (L = (a - (i.slidesPerView - 1) * E) / i.slidesPerView),
              i.roundLengths && (L = Math.floor(L)),
              u[r] && (u[r].style[t("width")] = `${L}px`);
          u[r] && (u[r].swiperSlideSize = L),
            S.push(L),
            i.centeredSlides
              ? ((M = M + L / 2 + C / 2 + E),
                0 === C && 0 !== r && (M = M - a / 2 - E),
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var t = document.getElementById("promo"),
      s = document.getElementById("works"),
      i = document.getElementById("documents");
    if (t)
      new U(".promoSwiper", {
        slidesPerView: 1,
        loop: !0,
    ...
    ((e) => {
      ...
      "scroll" in window &&
        (function () {
          ...
          e.forEach((e) => {
            const s = parseInt(e.dataset.stickyTop) || 0,
              i = parseInt(e.dataset.stickyBottom) || 0,
              r = e.hasAttribute("data-sticky-header")
                ? document.querySelector("header.header").offsetHeight
                : 0,
              n = e.querySelector("[data-sticky-item]");
            if (!n) return;
            const a = e.offsetTop,
              o = a + e.offsetHeight;
            window.addEventListener("scroll", function () {
              ...
              if (e >= a && e <= o) {
                ...
                if (e >= a && e <= d)
                  ...
                  n.offsetLeft + n.offsetWidth >= e &&
                    (n.style.width = e - n.offsetLeft + "px");
                } else
                  (n.style.position = "relative"),
                    (n.style.bottom = "auto"),
                    (n.style.top = `${s}px`),
                    (n.style.right = "auto"),
                    (n.style.width = "auto");
              } else (n.style.position = "relative"), (n.style.bottom = "auto"), (n.style.top = "auto"), (n.style.right = "auto"), (n.style.width = "auto");
            });
          });
        })();
    const r = document.querySelectorAll("[data-popup]"),
      n = document.querySelectorAll("[data-close]");
    function a(e) {
      e.preventDefault();
