...
class DOMParser extends Base
{
	...
	protected $arAllCssNodeLinks = [];
	protected $arAllCssStyle = [];
	protected $arAllCssNodeStyle = [];
	protected $arAllJsScript = [];
	protected $arAllJsNodeLinks = [];
	protected $arAllJsScriptWithBxLoadCss = [];
	protected $arAllJsNodeLinksWithBxLoadCss = [];
	protected $arAllImages = [];
	protected $arAllImagesNodeLinks = [];
	protected $arAllImagesTagNodeLinks = [];
	protected $arAllLazy = [];
	protected $arAllIFrameLazy = [];
	protected $arAllCssLazy = [];
	protected $arImageTypes = [
		"jpg" => "jpg",
		"jpeg" => "jpeg",
		"png" => "png",
		"gif" => "gif",
	...
	protected $arOtherOptions = [];

	protected $arAllAntiLazy = [];
	protected $arAllAntiLazyLinks = [];

	public function __construct($bCheckNotValidOpenTag = false, $arOtherOptions = [])
	{
	...
	public function AddTag($strXPathParent, $strTag, $arAttributes = [], $strTagContent = '', $bFirstChild = false)
	{
	...
	public function AddTagBeforeCssLink($iCssLinkIndex, $strTag, $arAttributes = [], $strTagContent = '')
	{
		$oNewTagNode = $this->DOM->createElement($strTag, $strTagContent);
		foreach ($arAttributes as $k => $v) {
			$oAttr = $this->DOM->createAttribute($k);
...
EOF;
	...
	{
		$this->arAllImages = [];
		$this->arAllImagesNodeLinks = [];
		$this->arAllImagesTagNodeLinks = [];
		$index = 1;
	...
	public function removeWhiteSpace()
	{
		...
		$arSkip = ["style", "pre", "code", "script", "textarea"];
	...
	{
		$this->arAllJsScriptWithBxLoadCss = [];
		$this->arAllJsNodeLinksWithBxLoadCss = [];
		$index = 1;
		$rAllNodes = $this->XPath->query("//script");
		for ($i = 0; $i < $rAllNodes->length; $i++) {
			/**
