...
$APPLICATION->IncludeComponent("bitrix:news.list", "main-offer", Array(
...
$APPLICATION->IncludeComponent("bitrix:news.list", "why", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		"ADD_SECTIONS_CHAIN" => "N",	// Включать раздел в цепочку навигации
		"AJAX_MODE" => "N",	// Включить режим AJAX
		"AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
...
$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"IBLOCK_TYPE" => "CONTENT",
		"SECTION_CODE" => "",
		"SECTION_FIELDS" => array(0=>"ID",1=>"NAME",2=>"DESCRIPTION",3=>"PICTURE",4=>"",),
		"SECTION_ID" => "0",
		"SECTION_URL" => "",
...
$APPLICATION->IncludeComponent("bitrix:news.list", "working", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		"ADD_SECTIONS_CHAIN" => "N",	// Включать раздел в цепочку навигации
		"AJAX_MODE" => "N",	// Включить режим AJAX
		"AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
